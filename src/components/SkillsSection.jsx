...
import BotsIcon from "@/assets/icons/bootstrap.png";
import reactIcon from "@/assets/icons/react.png";
import nets from "@/assets/icons/netlify.png";
import tailwindIcon from "@/assets/icons/tailwind.png";
import nodejsIcon from "@/assets/icons/nodejs.png";
import expressIcon from "@/assets/icons/express.png";
import mongodbIcon from "@/assets/icons/mongodb.png";
import postm from "@/assets/icons/postman.png";
import viteIcon from "@/assets/icons/Vite2.png";
...
const skills = [
  ...
  { name: "Postman", level: 70, category: "tools", icon: "postman" },
  { name: "Vite", level: 80, category: "tools", icon: "vite" },
  { name: "VS Code", level: 95, category: "tools", icon: "vscode" },
  { name: "Netlify", level: 90, category: "tools", icon: "netlify" },
